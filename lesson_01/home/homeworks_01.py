...
mark_mistectvo=20
mark_zviri=7
mark_podarynok_1=mark_mistectvo-5
mark_podarynok_2=mark_zviri-1
vsogo=mark_podarynok_1+mark_podarynok_2
print (vsogo)
...
hlopchik = 24
divchatka = 24//2
hlopchsk_priyshov = hlopchik - 1
divchatka_priyshov = divchatka - 2
vsogo = hlopchsk_priyshov + divchatka_priyshov
print (vsogo)
